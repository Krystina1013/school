...
export function carTypeList() {
  return _axios({
    url:config.v2+ '/csia/vehicle/vehicleType',
    method: 'get'
  })
}
// 车牌类型Arr
export function carNumArr() {
  return _axios({
    url:config.v2+ '/csia/vehicle/licenseType',
    method: 'get'
  })
}
// 首页获取车辆通行记录
...
export function queryCarPhone(phone) {
  return _axios({
    url:config.v1+ '/admin/scence-user/like-by-phone/',
    method: 'get',
    params: {
      phone
    }
...
export function addCar(data) {
  return _axios({
    url:config.v1+ '/admin/usr-car/batch-add/',
    method: 'post',
    data
  })
}
...
export function getUserPropertyCar(id: string) {
  return _axios({
    url:config.v1+ '/admin/usr-car/byUserId',
    method: 'get',
    params: {
      id
    }
...
export function getvisitUser(id: string) {
  return _axios({
    url:config.v1+ '/admin/usr-visit-car/get-one/',
    method: 'get',
    params: {
      id
    }
...
export function getCarRecord(id: string) {
  return _axios({
    url:config.v1+ '/admin/usr-car/get-one',
    method: 'get',
    params: {
      id
    }
...
export function getHouseTreeData() {
  return _axios({
    url:config.v1+ '/admin/car-space-group',
    method: 'get'
  })
}
...
export function addHouseGroups(data: Object) {
  return _axios({
    url:config.v1+ '/admin/car-space-group/batch-create',
    method: 'post',
    data
  })
}
...
export function updateHouseGroup(data: Object) {
  return _axios({
    url:config.v1+ `/admin/car-space-group/${data['id']}/`,
    method: 'patch',
    data
  })
}
...
export function deleteHouseGroup(id: string) {
  return _axios({
    url:config.v1+ `/admin/car-space-group/${id}/`,
    method: 'delete',
  })
}
...
export function getStall() {
  return _axios({
    url:config.v1+ '/admin/car-space-type/',
    method: 'get'
  })
}
...
export function editStall(data: any) {
  return _axios({
    url:config.v1+ `/admin/car-space/${data.id}/`,
    method: 'patch',
    data
  })
}
...
export function getCarStallByUserId(userList:Array<string>) {
  return _axios({
    url:config.v1+ '/admin/car-space/search-user',
    method: 'get',
    params: {
      userList
    }
...
export function addcarno(data: any) {
  return _axios({
    url:config.v1+ `/admin/car-space/${data.id}/add-card`,
    method: 'post',
    data
  })
}
...
export function deleteCarno(data: any) {
  return _axios({
    url:config.v1+ `/admin/car-space/${data.id}/delete-card/`,
    method: 'delete',
    data
  })
}
...
export function batchStall(data: any) {
  return _axios({
    url:config.v1+ `/admin/car-space/batch-create`,
    method: 'post',
    data
  })
}
