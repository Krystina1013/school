...
export function updateManager(data: object) {
  return _axios({
    url:config.v1+ '/admin/scence-admin/update',
    method:'put',
    data
  })
}
...
export function addManager(data: object) {
  return _axios({
    url:config.v1+ '/admin/scence-admin/insert',
    method: 'post',
    data
  })
}
...
export function getRoleList(name: string | null) {
  return _axios({
    url:config.v1+ '/admin/usrRole/list',
    method: 'get',
    params: {
      name
    }
...
export function updateRole(data: object) {
  return _axios({
    url:config.v1+ '/admin/usrRole/updatePermission',
    method: 'put',
    data
  })
}
...
export function getWarning(params: Object) {
  return _axios({
    url:config.v1+ '/admin/usr-early-contact/',
    method: 'get',
    params
  })
}
...
export function editWarning(data: Object) {
  return _axios({
    url:config.v1+ `/admin/usr-early-contact/${data['id']}/`,
    method: 'patch',
    data
  })
}
...
export function deleteWarning(id: any) {
  return _axios({
    url:config.v1+ `/admin/usr-early-contact/${id}/`,
    method: 'delete',
  })
}
...
export function getGroup() {
  return _axios({
    url:config.v1+ '/admin/usr-early-group/',
    method: 'get',
  })
}
...
export function deleteGroup(id: any) {
  return _axios({
    url:config.v1+ `/admin/usr-early-group/${id}/`,
    method: 'delete'
  })
}
...
export function editArgumentsStall(data: Object) {
  return _axios({
    url:config.v1+ `/admin/car-space-type/${data['id']}/`,
    method: 'patch',
    data
  })
}
...
export function getSuperCardList() {
  return _axios({
    url:config.v1+ '/admin/hsDoorCard/super',
    method: 'get'
  })
}
