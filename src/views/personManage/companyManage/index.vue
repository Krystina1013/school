        ...
        <div class="rightContent">
          <el-row>
            <el-col :span="24">
              <action-header
                :goToWork="true"
                @showDialogRuleDes="$refs.rule.dialog.visible = true"
                @changeWorkMonth="fetchInit"
              ...
              >
              <!-- <div slot="faceImport">
                 <el-button type="primary" size="small" icon="el-icon-export"  command="export">
                  导出
                </el-button>
              </div> -->
          ...
          >
            ...
            >
              <template slot-scope="scope">
                <span
                  >{{ scope.row.lateCount }}次/{{
                    scope.row.lateMinute
                  }}分钟</span
                >
              </template>
            </el-table-column>
            ...
            >
              <template slot-scope="scope">
                <span
                  >{{ scope.row.earlyCount }}次/{{
                    scope.row.earlyMinute
                  }}分钟</span
                >
              </template>
            </el-table-column>
            ...
            >
              ...
              >
                <template slot-scope="scope">
                  ...
                  <div
                    v-if="
                      scope.row.timeData.find(
                        (item) => item.writeDate.substring(8, 10) == index + 1
                      )
                    "
                  >
                      ...
                      <div slot="content">
                        <div>
                          上班时间：{{
                            scope.row.timeData.find(
                              (item) =>
                                item.writeDate.substring(8, 10) == index + 1
                            ).upTime
                          }}
                          <br />
                          下班时间：{{
                      ...
                      <div class="flex">
                        <div class="check-style">
                          ...
                          <span
                            ...
                            "
                            ><i style="color: #039a9a" class="el-icon-check"></i
                          ></span>
                          <span
                            class="icon"
                            v-else-if="
                  ...
                  <div v-else-if="!onlyChangeDate && filterForm.date.substring(5,8)<month&&year>=filterForm.date.substring(0,4)" class="nocheck"> 
                  </div>  -->
                  <span v-else></span>
                  <span></span>
                </template>
...
export default class CardManage extends Vue {
  ...
  initForm: object = {
    url: config.v1 + "/admin/attendance-record",
    method: "get",
    params: {
      date: this["$util"].getOffsetDate(0).substring(0, 7),
    },
  };
  exportUrl: string = config.v1 + "/admin/attendance-record/export";
  days: any = [];
  timeDataIndex = 0;
  ...
  planDate: string = "";
  searchMonth: any = "";
  onlyChangeDate: boolean = true;
  attention: Array<object> = [];
  exportName: string = "考勤.xlsx";
  mounted() {}
  changeDate() {
    this["onlyChangeDate"] = true;
  }
  created() {
    this.getAttention();
    ...
    this.exportName = year + "年" + month + "月的考勤.xlsx";
