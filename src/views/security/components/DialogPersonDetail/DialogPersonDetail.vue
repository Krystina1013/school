<template>
  <div>
    <el-dialog title="抓拍详情" :visible="visible" :append-to-body='true' width="1212px" :before-close="handleClose">
        ...
        <div class="right-layout">
          ...
          <div class="cameraDetail title-list">
            ...
            <div class="person-con">
              <h2 class="title">» 人员信息：</h2>
              <div class="commonRow text-con" v-if="form.goodFace === 0 && form.scenceUserList.length === 0">
                非清晰人脸
              </div>
              <div class="commonRow text-con" v-if="form.goodFace === 1 && form.scenceUserList.length === 0">
                陌生人
              </div>
            ...
            <!-- <div class="person-con" v-if="form.faceInfo && form.faceInfo.occlusion">
              <h2 class="title">» 人脸特征：</h2>
              <div class="commonRow" v-if="form.faceInfo">
                <div class="label">人脸模糊度：</div>
                <div class="value">
                  <span >{{
                    form.faceInfo.faceBlur
                  }}</span>
                </div>
              </div>
              <div class="commonRow" v-if="form.faceInfo.occlusion">
                <div class="label">左眼遮挡比例：</div>
                <div class="value">
                  <span>{{
                    form.faceInfo.occlusion.left_eye
                  }}</span>
                </div>
              </div>
              <div class="commonRow" v-if="form.faceInfo.occlusion">
                <div class="label">右眼遮挡比例：</div>
                <div class="value">
                  <span>{{
                    form.faceInfo.occlusion.right_eye
                  }}</span>
                </div>
              </div>
              <div class="commonRow" v-if="form.faceInfo.occlusion">
                <div class="label">嘴巴遮挡比例：</div>
                <div class="value" >
                  <span >{{ form.faceInfo.occlusion.mouth }}</span>
                </div>
              </div>
              <div class="commonRow" v-if="form.faceInfo.occlusion">
                <div class="label">鼻子遮挡比例：</div>
                <div class="value" >
                  <span >{{ form.faceInfo.occlusion.nose }}</span>
                </div>
              </div>
              <div class="commonRow" v-if="form.faceInfo.occlusion">
                <div class="label">左脸颊遮挡比例：</div>
                <div class="value">
                  <span >{{ form.faceInfo.occlusion.left_cheek }}</span>
                </div>
              </div>
              <div class="commonRow" v-if="form.faceInfo.occlusion">
                <div class="label">右脸颊遮挡比例：</div>
                <div class="value" >
                  <span >{{ form.faceInfo.occlusion.right_cheek }}</span>
                </div>
              </div>
              <div class="commonRow" v-if="form.faceInfo.occlusion">
                <div class="label">下巴遮挡比例：</div>
                <div class="value" >
                  <span>{{ form.faceInfo.occlusion.chin_contour }}</span>
                </div>
              </div>
              <div class="commonRow" v-if="form.angle && form.angle.pitch">
                <div class="label">俯仰角度：</div>
                <div class="value" >
                  <span >{{ form.angle.pitch }}</span>
                </div>
              </div>
            </div> -->
          </div>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <!-- <el-button type="primary" size="mini" v-if="form.faceInfo && form.faceInfo.occlusion" @click="
...
import { getInfoByFaceIds } from "@/api/user";
