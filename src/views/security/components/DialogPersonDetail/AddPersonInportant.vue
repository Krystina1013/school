<template>
  <div>
    <el-dialog :close-on-click-modal="false" title="添加到关注人员" :append-to-body='true' :visible.sync="visible" width="700px" :before-close="handleCloseAdd" @open="opened">
        ...
        <el-row :gutter="0">
          <el-col :span="12">
            <el-form-item label="证件类型：" prop="cardType">
              ...
              <!-- <div
                v-show="ruleForm.cardType == '其它'"
                style="margin-top: 10px"
              >
                证件名称：
                <el-input
                  v-model="otherCardType"
                  style="width: 200px"
                  maxlength="32"
                ></el-input>
              </div> -->
