    ...
    >
      <el-form :model="ruleForm" ref="ruleForm" label-width="130px">
        <el-form-item
                  ...
                  prop="alertTaskId"
                >
                  <el-select size="mini" placeholder="选择所属分组" v-model="ruleForm.alertTaskId" maxlength="100">
          ...
          <div class="photoWrapper">
            ...
            <div class="body">
              ...
              >
                ...
                >
                  <el-input size="mini" v-model="item.name" maxlength="10"></el-input>
                </el-form-item>
                <i
...
import { faceDetect, faceUpload, addImportantPerson, importantGroup } from "@/api/police";
...
export default class importantPerson extends Vue {
  ...
  created() {
    console.log(this.dialogEditPortrait.groupData)
    //  this.getLeftTree();
  }
}
</script>
