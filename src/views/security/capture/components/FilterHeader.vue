          ...
          <div class="content">
            ...
            <transition name="el-zoom-in-top">
              <div v-show="visibleFilter" class="filterDialog">
                <div class="word-filter" npm>
                  <span class="filter-name">人&nbsp;&nbsp;&nbsp;像:</span>
                  <el-upload ref="upload" class="avatar-uploader" drag :action="config.v1 + '/admin/scence-user/upFace'" accept="image/*" :auto-upload="false" :show-file-list="false" :on-change="beforeAvatarUpload">
                ...
                <div class="word-filter" v-if="activeName == 'track'">
                ...
                <div class="word-filter">
                  ...
                  <el-input v-model.trim="picFilterForm.name" maxlength="20"></el-input>
                  <!-- <el-date-picker v-show="time == 4" value-format="yyyy-MM-dd HH:mm:ss" v-model="dateRange" type="datetimerange" range-separator="-" start-placeholder="开始时间" end-placeholder="结束时间"></el-date-picker> -->
                </div>
                <div class="word-filter">
                  <span class="filter-name">学号:</span>
                  <el-input v-model.trim="picFilterForm.studentNo" maxlength="20"></el-input>
                  <!-- <el-date-picker v-show="time == 4" value-format="yyyy-MM-dd HH:mm:ss" v-model="dateRange" type="datetimerange" range-separator="-" start-placeholder="开始时间" end-placeholder="结束时间"></el-date-picker> -->
                </div>
                <div class="word-filter">
                  <span class="filter-name">手机号:</span>
                  <el-input v-model.trim="picFilterForm.phone" maxlength="20"></el-input>
                  <!-- <el-date-picker v-show="time == 4" value-format="yyyy-MM-dd HH:mm:ss" v-model="dateRange" type="datetimerange" range-separator="-" start-placeholder="开始时间" end-placeholder="结束时间"></el-date-picker> -->
                </div>
...
export default class extends Vue {
  ...
  //轨迹搜索
  // getTrack() {
  //   this.$emit("getTrack", this.picFilterForm);
  // }
  sizeChange() {
  ...
  clearFilterFormfresh() {
    ...
    this.visible = false;
    this.hasProty = false;
    this.picFilterForm.name = "";
    this.picFilterForm.studentNo = "";
    this.picFilterForm.phone = "";
  ...
  searchTrack(val) {
    ...
    this.picFilterForm.faceUrl = val.faceUrl;
    this.similarity.map((item: any) => {
      if (item.label.indexOf("高") != -1) {
        this.picFilterForm.score = item.value;
      }
