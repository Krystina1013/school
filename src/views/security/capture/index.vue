<template>
  <div class="layout-content1">
    <FilterHeader :activeName="activeName" class="header-handle" ref="filter" @getFaceCapture="getFaceCapture"  :pageInfo="pagination"></FilterHeader>
    <!-- :style="`height:${height_w - 250}px`" -->
  <div class="resultWrapper" v-loading="showLoading">
    <!-- :height="height_w - 310" -->
      <ScrollList class="scollList" ref="scrollList" :height="height_w - 120" :canPullUp="canPullUp" @scrollToBottom="scrollToBottomTime" v-if="searchData.length">
        <div class="list" v-for="(item, i) in searchData" :key="i" @click="showDialogPersonDetail(item)">
          <div style="position: relative;padding:2px">
            ...
            <div style="position: relative;z-index: 5;">
              ...
              <!-- <div class="flex align-items-center rowp" style="margin:2px 0">
              ...
              <div class="flex rowp" style="margin-top:4px;">
...
import { unknownFaceSearch, unknownFaceTimeSearch } from "@/api/police";
import {
  getBase64,
  getTimeByTimeStamp,
