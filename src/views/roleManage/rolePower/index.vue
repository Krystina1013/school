          ...
          >
                ...
                <div v-if="globalUpdateStatus" class="fun-btn">
                  ...
                  >
                    ...
                    <el-dropdown-menu slot="dropdown">
                      <el-dropdown-item
                        v-if="deleteForm.data.length < 2"
                        :command="returnCommand('update', scope.row)"
                        >修改</el-dropdown-item
                      >
            ...
            <el-table-column align="center" label="权限">
              <template slot-scope="{ row }">
                <el-button @click="updateRoleAction(row)" type="text"
                  >修改权限</el-button
                >
              </template>
            </el-table-column>
    ...
    >
      <el-form ref="Forms" :rules="rules" :model="Form" label-width="80px">
        ...
        <el-form-item
          label="备注"
          maxlength="200"
          placeholder="输入角色备注说明(最多200字)"
          prop="note"
        >
          <el-input
            maxlength="200"
            placeholder="请输入角色备注信息"
            @input="constraintLength(Form.note, '200')"
            type="textarea"
            v-model="Form.note"
          ></el-input>
        </el-form-item>
